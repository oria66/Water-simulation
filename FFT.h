...
namespace Hydrax{ namespace Noise
{
    ...
    private:
        ...
        /** Get the P-M Spectrum, used to create the amplitudes and phases
            @param waveVector Wave vector
            @param wind Wind direction
            @param winds Wind speed
            @return P-M Spectrum
         ...
         */
        const float _getPM1sSpectrum(const Ogre::Vector2& waveVector, const Ogre::Vector2& wind, const float& kwPower_,const float& winds) const;
        const double _getP_MSpectrum(const Ogre::Vector2& waveVector,const Ogre::Vector2& wind, const float& winds) const;

        /** Get the Jonswap Spectrum, used to create the amplitudes and phases
            @param waveVector Wave vector
            @param wind Wind direction
            @param winds Wind speed
            @param fetch fetch
         ...
         */
        const double _getJONSWAPSpectrum(const Ogre::Vector2& waveVector,const Ogre::Vector2& wind, const float& winds,const float& fetch) const;

        /** Get the TMA Spectrum, used to create the amplitudes and phases
            @param waveVector Wave vector
            @param wind Wind direction
            @param winds Wind speed
            @param fetch fetch
            ...
            @return TMA Spectrum
         */
        const double _getTMASpectrum(const Ogre::Vector2& waveVector,const Ogre::Vector2& wind, const float& winds,const float& fetch,const float& depth) const;
